...
const knockoutData = {
  ...
  { home: '🇸🇳 Senegal', score: '2-2 ET(1-0)',  away: '🇮🇩 Indonesia' },
  { home: '🏴 England',score: '2-1',    away: '🇹🇭 Thailand' },
  { home: '🇧🇪 Belgium',  score: '3-3 PK(4-1)',  away: '🇨🇲 Cameroon' },
  { home: '🇩🇪 Germany', score: '0-1',  away: '🇺🇿 Uzbekistan' },
  { home: '🇩🇿 Algeria', score: '3-2',  away: '🇶🇦 Qatar' },
  { home: '🇪🇸 Spain', score: '2-2 PK(3-1)',    away: '🇬🇭 Ghana' },
  { home: '🇨🇴 Colombia',score: '2-1',  away: '🇺🇦 Ukraine' },
  { home: '🇲🇦 Morocco',score: '1-0',   away: '🇨🇦 Canada' },
  ...
  roundOf16: [
    ...
    { home: '🇮🇹 Italy', score: '2-1',    away: '🇷🇺 Russia' },
  ] as KMatch[],
  quarterfinals: [
    { home: '🇦🇷 Argentina', score: '1-3', away: '🇺🇸 USA' },
    { home: '🇧🇪 Belgium',score: '1-0',    away: '🇩🇿 Algeria' },
    { home: '🇪🇸 Spain', score: '3-2',    away: '🇲🇦 Morocco' },
    { home: '🇫🇷 France',score: '1-1 PK(2-3)',     away: '🇮🇹 Italy' },
  ] as KMatch[],
  semifinals: [
    { home: '🇺🇸 USA', score: '4-3', away: '🇧🇪 Belgium'},
    { home: '🇪🇸 Spain', score: '',    away: '🇮🇹 Italy'},
  ] as KMatch[],
  thirdPlace: [ 
    { home: '🇧🇪 Belgium', score: '', away: ''},] as KMatch[],
  final: [ 
    { home: '🇺🇸 USA', score: '', away: ''},] as KMatch[],
};
