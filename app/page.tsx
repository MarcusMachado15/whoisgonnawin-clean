...
const groupStandingsEurope: Record<string, Standing[]> = {
  'Group A WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Wales(Q)',       played: 4, won: 2, draw: 2, lost: 0, gf: 10, ga: 5,  gd: +5, pts: 8 },
  { pos: 2, team: 'Spain(Q)',       played: 4, won: 2, draw: 2, lost: 0, gf:  9, ga: 7,  gd: +2, pts: 8 },
  ...
  'Group B WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'France(Q)',     played: 4, won: 4, draw: 0, lost: 0, gf: 10, ga: 1,  gd: +9, pts: 12 },
  { pos: 2, team: 'Sweden(Q)',     played: 4, won: 3, draw: 0, lost: 1, gf: 10, ga: 5,  gd: +5, pts:  9 },
  ...
  'Group C WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Russia(Q)',       played: 4, won: 2, draw: 2, lost: 0, gf: 9, ga: 5, gd: +4, pts: 8 },
  { pos: 2, team: 'England(Q)',      played: 4, won: 1, draw: 3, lost: 0, gf: 5, ga: 4, gd: +1, pts: 6 },
...
'Group D WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Israel(Q)',      played: 4, won: 3, draw: 1, lost: 0, gf: 12, ga: 5,  gd: +7, pts: 10 },
  { pos: 2, team: 'Ukraine(Q)',     played: 4, won: 2, draw: 1, lost: 1, gf:  6, ga: 5,  gd: +1, pts:  7 },
...
'Group E WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Norway(Q)',   played: 4, won: 2, draw: 2, lost: 0, gf: 10, ga:  8, gd: +2, pts: 8 },
  { pos: 2, team: 'Ireland(Q)',  played: 4, won: 1, draw: 3, lost: 0, gf:  5, ga:  4, gd: +1, pts: 6 },
  ...
  'Group F WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Belgium(Q)',     played: 4, won: 2, draw: 1, lost: 1, gf: 7, ga: 3,  gd: +4, pts: 7 },
  { pos: 2, team: 'Czech Rep.(Q)',  played: 4, won: 2, draw: 1, lost: 1, gf: 7, ga: 4,  gd: +3, pts: 7 },
  ...
  'Group G WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Italy(Q)',       played: 4, won: 4, draw: 0, lost: 0, gf: 9, ga: 3,  gd: +6, pts: 12 },
  { pos: 2, team: 'Switzerland(Q)', played: 4, won: 2, draw: 1, lost: 1, gf: 8, ga: 5,  gd: +3, pts:  7 },
  ...
  'Group H WC Qualifiers Argentina 2025': [
  { pos: 1, team: 'Romania(Q)',  played: 4, won: 4, draw: 0, lost: 0, gf: 10, ga:  2, gd: +8, pts: 12 },
  { pos: 2, team: 'Germany(Q)', played: 4, won: 2, draw: 0, lost: 2, gf:  8, ga:  6, gd: +2, pts:  6 },
...
const groupMatchesAfrica: Record<string, Match[]> = {
  'Group A WC Qualifiers Argentina 2025': [
    ...
    { home: '🇿🇲 Zambia',       score: '1 - 2', away: '🇨🇲 Cameroon'   },
    { home: '🇲🇱 Mali',         score: '0 - 0', away: '🇰🇪 Kenya'      },
  ],
  ...
  'Group B WC Qualifiers Argentina 2025': [
    ...
    { home: '🇬🇳 Guinea',       score: '4 - 2', away: '🇹🇳 Tunisia'     },
    { home: '🇿🇦 South Africa', score: '2 - 1', away: '🇿🇼 Zimbabwe'    },
  ],
  ...
  'Group D WC Qualifiers Argentina 2025': [
    ...
    { home: '🇬🇭 Ghana',        score: '2 - 2 ', away: '🇨🇮 Ivory Coast'},
    { home: '🇧🇫 Burkina Faso', score: '1 - 3', away: '🇸🇴 Somalia'    },
  ],
};
...
const groupStandingsAfrica: Record<string, Standing[]> = {
  ...
  { pos: 3, team: 'Guinea(Q)',       played: 4, won: 1, draw: 2, lost: 1, gf:  7, ga:  6, gd: +1, pts: 5 },
  ...
  { pos: 3, team: 'Algeria(Q)',     played: 4, won: 2, draw: 0, lost: 2, gf: 12, ga: 12, gd:  0, pts: 6 },
...
const groupMatchesAsia: Record<string, Match[]> = {
  'Group A WC Qualifiers Argentina 2025': [
    ...
    { home: '🇰🇼 Kuwait',       score: '3 - 0', away: '🇧🇭 Bahrain'      },
    { home: '🇳🇿 New Zealand',  score: '2 - 1', away: '🇵🇭 Philippines'  },
  ],
  ...
  'Group B WC Qualifiers Argentina 2025': [
    ...
    { home: '🇲🇾 Malaysia',     score: '0 - 2', away: '🇴🇲 Oman'        },
    { home: '🇨🇳 China',        score: '4 - 1', away: '🇭🇰 Hong Kong'  },
  ],
  ...
  'Group C WC Qualifiers Argentina 2025': [
    ...
    { home: '🇮🇳 India',        score: '0 - 2', away: '🇦🇪 UAE'         },
    { home: '🇹🇭 Thailand',     score: '3 - 2', away: '🇸🇬 Singapore'  },
  ],
  ...
  'Group D WC Qualifiers Argentina 2025': [
    ...
    { home: '🇮🇩 Indonesia',    score: '0 - 0', away: '🇯🇴 Jordan'      },
    { home: '🇵🇸 Palestine',    score: '2 - 1', away: '🇲🇲 Myanmar'     },
  ],
  ...
  'Group E WC Qualifiers Argentina 2025': [
    ...
    { home: '🇰🇵 North Korea',  score: '2 - 2', away: '🇮🇶 Iraq'        },
    { home: '🇰🇬 Kyrgyzstan',   score: '2 - 1', away: '🇳🇵 Nepal'      },
  ],
...
'Group A WC Qualifiers Argentina 2025': [
  ...
  { pos: 5, team: 'Nepal',       played: 4, won: 0, draw: 0, lost: 4, gf: 2,  ga: 9, gd: -7, pts: 0 },
],
